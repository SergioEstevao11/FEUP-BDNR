    ...
    return (
      <main className='bg-white p-0 sm:mb-20 m-auto'>
        <div className='flex flex-col p-0 sm:m-auto justify-center items-center'>
          <a href='/' className='flex justify-center items-center select-none text-3xl mt-12'>
            <h1> A </h1>
            <h1 className="text-janus font-bold"> Network </h1>
            <h1> Of Thrones</h1>
          </a>
          <h3 className="text-2xl my-2 mb-10">A JanusGraph prototype to analyze kinship and conflicts in Europe</h3>
